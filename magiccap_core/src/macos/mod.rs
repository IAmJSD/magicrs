...
extern "C" {
    ...
    pub fn create_tray(
        uploader_items: *const UploaderItem,
        uploader_items_len: usize,
        capture_types: *const CaptureType,
        capture_types_len: usize,
        on_click: unsafe extern "C" fn(
            name_ptr: *const u8,
            name_len: usize,
            path_ptr: *const u8,
            path_len: usize,
        ...
        on_quit: extern "C" fn(),
        on_capture_type_clicked: extern "C" fn(type_: c_int),
        on_config: extern "C" fn(),
    ) -> usize;
}
